    ...
    <div className=" w-sceen  h-[635px] mt-[5%] flex desktopview_aboutus   mr-0 " >
      ...
      <div className=" w-[94.3%] h-full border-solid border-[0.5px]  AboutUs flex overflow-hidden   ">
        ...
        <div id="myDiv1" className=' h-full flex' style={{ cursor: 'pointer', width: '70%' }}  >
          ...
          <div id='img2' style={{ width: '100%', display: 'flex' }}    >
            <div className=' block w-[100%] Aboutus'>
             ...
             {/* one check  */}
              ...
              Our Medicare app streamlines healthcare management with its intuitive platform. Easily schedule appointments, track prescriptions, and access medical records securely. It promotes seamless communication with healthcare providers for quick consultations and updates. With robust security measures, your sensitive information remains protected. Take charge of your health effortlessly with our user-friendly interface.
              </div>
          ...
          <div id='img1' onClick={handleClick1} className="rect w-[100%]" style={{ display: 'none', zIndex: '12' }}>
            {/* after click */}
            <div className="rect text-black items-center flex flex-col  justify-between">
              ...
              <h1 className="transform rotate-90  font-serif text-6xl font-semi_bold tracking-wider">ABOUT_US</h1>
          ...
          <div id='img3' onClick={handleClick2} className='flex rect   ' style={{ width: '100%', zIndex: '9'  }}>
            ...
            <div className="rect text-black items-center flex flex-col  justify-between">
              ...
              <div className='w-[-30%]'>
                ...
                {/* This is my div222 */}
                {/* <div className='w-[100%] rotate-90 overflow-hidden '>
                <p className='font-michroma font-normal text-[50px]'>UDYAM</p>

                </div> */}
                <h1 className="transform rotate-90  font-serif text-6xl font-semi_bold tracking-wider">APPOINTMENT</h1>
...
Appointment booking systems streamline scheduling, enabling healthcare providers to efficiently manage patient appointments. They simplify administrative tasks, minimize errors, and ensure seamless communication between patients and providers. Patients benefit from convenient scheduling options and automated reminders. Providers can optimize resource allocation and analyze appointment data to enhance care delivery.
              </div>
        ...
        <div id="myDiv3" className=' h-full flex ' style={{ cursor: 'pointer', width: '10%' }}>
          ...
          <div id='img5' onClick={handleClick3} className='flex   ' style={{ width: '100%', zIndex: '9' }}>
            ...
            <div className="rect text-black items-center flex flex-col  justify-between">
              ...
              <div className='w-[-80%] ]'>
              <h1 className="transform rotate-90  font-serif text-6xl font-semi_bold tracking-wider">HISTORY</h1>
          ...
          <div id='img6' className='flex' style={{ width: '100%', display: 'none' }}>
            ...
            <div className=' block w-[100%] Aboutus'>
              ...
              {/* border-solid border-[0.5px] */}
              <div className=' flex text-white w-[60vw] h-[315px] ml-[44px]    textarea mt-[40px]'>
Medical history systems streamline data management for better healthcare coordination, improving patient safety and treatment outcomes. They facilitate quick access to critical information, aiding diagnoses and treatment planning. By centralizing patient records, these platforms enhance communication among healthcare providers, ensuring comprehensive and personalized care delivery. Overall, they optimize healthcare processes, leading to more efficient workflows and improved patient outcomes.
              </div>
              <div className="  ml-[15%] mt-[0px]  ">
              <svg width="46vw" height="49" viewBox="0 0 792 59" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="396.58" height="59" fill="white" />
        ...
        <div id="myDiv4" className=' h-full flex ' style={{ cursor: 'pointer', width: '10%' }}>
          ...
          <div id='img7' onClick={handleClick4} className='flex   ' style={{ width: '100%',zIndex: '12' }}>
            ...
            <div className="rect text-black flex  items-center flex-col  justify-between">
              ...
              <div className='w-[-50%]'>
              <h1 className="transform rotate-90  font-serif text-6xl font-semi_bold tracking-wider">DOCTOR</h1>
          ...
          <div id='img8' className='flex' style={{ width: '100%', display: 'none' }}>
            <div className=' block w-[100%] Aboutus'>
              ...
              {/* border-solid border-[0.5px] */}
              <div className=' flex text-white w-[60vw] h-[315px] ml-[44px]    textarea mt-[40px]'>
              Our doctor database serves as a centralized hub for essential physician information, offering quick access to specialties, qualifications, and schedules. This streamlined system optimizes patient care coordination, enabling efficient appointment booking and seamless communication among healthcare teams. With robust data management features, it ensures secure storage of sensitive information while enhancing overall operational efficiency in medical practices.
              </div>
              <div className="  ml-[15%] mt-[0px]  ">
              <svg width="46vw" height="49" viewBox="0 0 792 59" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="396.58" height="59" fill="white" />
